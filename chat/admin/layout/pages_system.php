...
<?php
	if ($do == "update") 
	{
		...
		$test = true;
		if (chat_VERSION == $current_version OR !$fp) 
		{
			$cv_msg = "You have the latest version of chat. You do not need to upgrade.";
			$cv_msg2 = "You have the latest version of chat. You do not need to upgrade. However, if you want to re-install version ".chat_VERSION.", you can download the package and re-install:";
		} 
		else 
		{
			$cv_msg = "There is a new version of chat.  Please download it below.";
			$cv_msg2 = "You do not have the latest version of chat, and need to upgrade. If your subscription is still active, you can download the update for free below:";
			$test = false;
		}
?>
					<div class="subtitle">Update chat</div>
                    <div class="subExplain">
                        <i>This process will update chat on your system to the latest version.  Please note that modifications to files may be overwritten and it is imperative that you backup your files and database before proceeding.<br /><br />If the automatic installation button does not appear: 1) You have the latest version, 2) Your PHP settings do not allow fopen on external URLs, or 3) Your server does not have the zip extension.</i>
                    </div>
					<fieldset>
					...
					<dl class="selectionBox submitBox">
						...
						<dd>
							<div class="floatr" style="float: right;">
								<a class="fwdbutton" onClick="window.open('http://www.chat.com/members/', 'new');return false;">
									<span>Install Manually</span>
								</a>
							</div>
					<?php
						if (chat_VERSION != $current_version AND chat_EDITION != "lite" AND chat_EDITION != "business") 
						{
							if ($fp) 
							{
...
?>
					...
					<fieldset>
						<iframe src="http://www.chat.com/purchase/change_log.html" border="0" width="695" height="200"></iframe>
					</fieldset>
...
?>
					...
					<div class="subExplain"><i>We need to make sure that you own an active chat license before we download the script for you.  Please enter your chat username and password that you use to login to chat.com.</i></div>
					<fieldset>
						<dl class="selectionBox">
							<dt>
								<label for="validate_username">chat Username</label>
							</dt>
							<dd>
								<input type="text" id="validate_username" class="selectionText" name="validate_username" value="" />
								<p class="explain">
									Your chat.com username.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
							<dt>
								<label for="validate_password">chat Password</label>
							</dt>
							<dd>
								<input type="password" id="validate_password" class="selectionText" name="validate_password" value="" />
								<p class="explain">
									Your chat.com password.
								</p>
							</dd>
						</dl>
					</fieldset>
...
<?php
	...
	{
?>
					<div class="subtitle">Updating chat</div>
					<div class="subExplain"><i>We are now updating your chat installation.  Please do not navigate away from this page.</i></div>
					<fieldset>
...
?>
					...
					<fieldset>
						<iframe src="http://www.chat.com/purchase/change_additional.html" width="695" height="200"></iframe>
					</fieldset>
					<div class="subtitle">Branding-Free Users</div>
					<div class="subExplain" style="margin-bottom:15px;"><i>You'll need to download the chat package from chat.com and replace the includes/js/chat_core.js file to remove the branding again.</i></div>
<?php	
	}
?>
					...
					<fieldset class="firstFieldset">
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Enter the path to chat from your www or public_html directory.  In most cases, this is simply "/chat/".  Be sure to include a trailing slash or it will automatically be added for you.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
					...
					<fieldset>
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Making this value smaller will use more server resources but chat will retrieve new messages faster. This value cannot be greater than the online timeout.  Default: 3
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Making this value smaller will use more server resources but chat will update the buddy list more often.  Default: 60
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
						...
						<dl class="selectionBox">
							...
							<dd>
								<ul>
									<li>
										<label for="push_on">
											<a href="http://www.chat.com/push/" target="_blank">Here</a>
										</label>
									</li>
								</ul>
								<p class="explain">
...
?>
                    ...
                    <div class="subExplain">
                        <i>Clicking the repair button will attempt to repair your chat database. If your chat suddenly does not work after upgrading to a new version, this repair feature may fix it. It should not delete your exisiting information, but please backup your database just in case.<br /><br />
...
<?php
	...
	{
?>
					<div class="subtitle">chat Maintenance</div>
                    <div class="subExplain">
                        <i>Your database can start to get large after running chat for a while with all the messages, guest users, etc.  It is highly recommended that you clear all this data out periodicly to make chat run like the first day you installed it.</i>
                    </div>
					<fieldset>
						<dl class="selectionBox">
							<dt>
