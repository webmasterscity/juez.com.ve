	...
	a.chat = function () {
		...
		function runchat() {
			if (a.cookie('ac_hide_mobile') != 1) {
				$body.append('<div id="chat_mobiletab_new"><span class="chat_mobiletab_new_count">0</span> ' + lang[115] + '</div><div id="chat_mobiletab" class="chat_mobiletab_hide">' + lang[145] + ' (<span id="chat_mobiletab_count">0</span>)</div>');
				a("#chat_mobiletab_new").hide();
				...
				a("#chat_mobiletab").click(function () {
		...
		function addToCount(number) {
			var count = parseInt(a(".chat_mobiletab_new_count").html()) + number;
			a(".chat_mobiletab_new_count").html(count);
			a("#chat_mobiletab_new").show();
			scaletab();
		}
		...
		function buildBuddyList(b) {
			...
			b && a.each(b, function (i, e) {
				if (i == "buddylist") {
					...
					a("#chat_mobiletab").html(lang[145] + ' (<span id="chat_mobiletab_count">' + onlineNumber + '</span>)');
				}
			})
		}
		function scaletab() {
			var tab = document.getElementById('chat_mobiletab');
			var newcount = document.getElementById('chat_mobiletab_new');
			...
			var count = parseInt(a(".chat_mobiletab_new_count").html());
			
			if (window.innerWidth > window.innerHeight) {
				// Landscape Mode
				tab.style.width = (lowerright[0] - lowerleft[0])/4 + 'px';
				tab.style.height = parseInt(window.innerHeight/8) + 'px';
				tab.style.left = lowerright[0] - a("#chat_mobiletab").outerWidth() - 20 + 'px';
				tab.style.top = lowerleft[1]-tab.offsetHeight + 'px';
				tab.style.fontSize = (lowerright[0] - lowerleft[0])/4/13 + 'px';
				
				newcount.style.width = (lowerright[0] - lowerleft[0])/12 + 'px';
				newcount.style.height = parseInt(window.innerHeight/12) + (a("#chat_mobiletab").outerHeight()/3)  + 'px';
				newcount.style.left = lowerright[0] - a("#chat_mobiletab_new").outerWidth() - 22 + 'px';
				newcount.style.top = lowerleft[1]-tab.offsetHeight-a("#chat_mobiletab_new").outerHeight()+(a("#chat_mobiletab").outerHeight()/1.35) + 'px';
				newcount.style.fontSize = (lowerright[0] - lowerleft[0])/12/7 + 'px';
				
				if ((lowerright[0] - lowerleft[0])/4 <= 50) {
					a("#chat_mobiletab").addClass("chat_mobiletab_hide");
					a("#chat_mobiletab_new").hide();
				} else {
					a("#chat_mobiletab").removeClass("chat_mobiletab_hide");
					if (count > 0)
						a("#chat_mobiletab_new").show();
				}
				...
				tab.style.left = lowerright[0] - a("#chat_mobiletab").outerWidth() - 20 + 'px';
				tab.style.top = lowerleft[1]-tab.offsetHeight + 'px';
				tab.style.fontSize = (lowerright[0] - lowerleft[0])/4/9 + 'px';
				
				newcount.style.width = (lowerright[0] - lowerleft[0])/6 + 'px';
				newcount.style.height = parseInt(window.innerHeight/20) + (a("#chat_mobiletab").outerHeight()/3)  + 'px';
				newcount.style.left = lowerright[0] - a("#chat_mobiletab_new").outerWidth() - 22 + 'px';
				newcount.style.top = lowerleft[1]-tab.offsetHeight-a("#chat_mobiletab_new").outerHeight()+(a("#chat_mobiletab").outerHeight()/1.5) + 'px';
				newcount.style.fontSize = (lowerright[0] - lowerleft[0])/12/4 + 'px';
			...
			if ((lowerright[0] - lowerleft[0])/2 <= 200) {
				a("#chat_mobiletab").addClass("chat_mobiletab_corners");
				a("#chat_mobiletab_new").addClass("chat_mobiletab_new_corners");
			} else {
				a("#chat_mobiletab").removeClass("chat_mobiletab_corners");
				a("#chat_mobiletab_new").removeClass("chat_mobiletab_new_corners");
			}
		}
