<?php
	...
	{
		if (check_array_for_match($group_id, $group_disable_chat_sep))
		{
		}
		else
		{
	...
	// ############################## START CSS ##############################
	// This is the primary CSS file for chat
	if ($type == "css") 
	{
	...
	if ($type == "djs") 
	{
		...
		$settings .= 'c_disable_chat="' . $disable_chat . '",';
		...
		require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . 'js/chat_dynamic.js');	
	...
	if ($type == "js") 
	{
		...
		{	
			if ($enable_mobile == 1)
			{
				...
				require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . 'js/chat_mobile.js');
			}
			else
			{
				close_session();
		...
		else
		{
			...
			require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . 'js/chat_libraries.js');
			
			echo "\n\n//**********Templates**********\n";
			require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . 'js/chat_templates.js');
			
			echo "\n\n// **********Main Script Start**********\n// http://www.chat.com\n";
			require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . 'js/chat_core.js');
