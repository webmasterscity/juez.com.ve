<?php
	...
	*/
	...
	function get_friend_list($userid, $time)
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_AVATAR . " avatar, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " link, chat_status.is_admin, chat_status.status, CONCAT(" . TABLE_PREFIX . "storage_files.path,'/'," . TABLE_PREFIX . "storage_files.name,'_t.'," . TABLE_PREFIX . "storage_files.extension) AS avatar
	...
	function get_user_details($userid)
	{
		...
		$sql = ("
			SELECT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity,  " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " link,  " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_AVATAR . " avatar, chat_status.is_admin, chat_status.status, CONCAT(" . TABLE_PREFIX . "storage_files.path,'/'," . TABLE_PREFIX . "storage_files.name,'_t.'," . TABLE_PREFIX . "storage_files.extension) AS avatar
			FROM " . TABLE_PREFIX . DB_USERTABLE . "
			LEFT JOIN chat_status
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = chat_status.userid
			LEFT JOIN " . TABLE_PREFIX . "storage_files
