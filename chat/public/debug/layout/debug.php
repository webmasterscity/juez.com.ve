...
?>
			If you are having trouble with getting chat running, this debug mode will help you find the problem.
			<br /><br />

			<table class="form-table"> 
				<tr> 
					<td width="20"><img src="<?php echo $base_url; ?>public/debug/images/reserve_tab_<?php echo $test_userid_img; ?>.png" alt="" /></td> 
					<th scope="row"><label for="phpver"><a href="javascript:;" class="vtip" title="This makes sure that you are currently logged in. If a user is not being registered as logged in, the chat bar may not show.">User ID</a></label></th> 
				...
				<tr> 
					...
					<th scope="row"><label for="configwrite"><a href="javascript:;" class="vtip" title="chat will not load in certain browsers. This is a check to make sure you are currently not using one of them.">Browser</a></label></th> 
				...
				<tr class="no-border"> 
					...
					<th scope="row"><label for="cachewrite"><a href="javascript:;" class="vtip" title="An integration file must exist for chat to function.">Integration File</a></label></th> 
