...
<div class="panel-heading">
				...
				<a title="Agregar nuevo registro" class="btn btn-success btn-sm" href="?<?php echo codificar('vista=mision_gobierno&evento=nuevo'); ?>">Agregar MIsiones del Gobierno</a>
				...
				<a class="btn btn-default btn-sm" href="?<?php echo codificar('vista=mision_gobierno'); ?>"  style="float:right; <?php if($_GET['evento']!='nuevo' and $_POST['evento']!='consultar') echo 'display:none;';?>">
...
if($mostrar_formulario==true){
	echo '<form method="post" action="?'.codificar('vista=mision_gobierno').'">';
