...
<?php
	...
	{
?>
					<div class="subtitle">Caracteristicas generales</div>
					<fieldset class="firstFieldset">
						<dl class="selectionBox">
							<dt>Caracteristicas de barra</dt>
							<dd>
								<ul>
									<li>
								...
								<p class="explain">
									Muestra un boton para que los usuarios puedan ocultar la barra.
								</p>
							</dd>
						</dl>
						<?php
							if (chat_EDITION == "lite")
							{
						?>
								...
								<ul>
									<li>
										<label for="chatrooms_on">
											...
											Activar salas de chat
										</label>
									</li>
								</ul>
								<p class="explain">
									Activa el servicio de salas de chat.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
						...
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Allows users to use the site notifications feature. This feature must first be installed correctly to function. Please visit http://www.chat.com/support/ for documentation on installation.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
...
&lt;div id="chat_public_list"&gt;&lt;/div&gt;</textarea>
								<p>
									<a title="Select all the code" href="javascript:;" id="buddy_list_select">Select All</a><br /><br />
								</p>
								<p class="explain">
									Please understand that this code must be put on a page where the chat djs script code and jQuery is on.
								</p>
							</dd>
						</dl>
					</fieldset>
								...
								<ul>
									<li>
										<label for="admin_chat_all">
											...
											chat Admins/Mods Can View All Online
										</label>
									</li>
								</ul>
								<p class="explain">
								...
								<ul>
									<li>
										<label for="admin_view_maintenance">
											...
											chat Admins Ignore Maintenance Mode
										</label>
									</li>
								</ul>
								<p class="explain">
					...
					<fieldset>
						...
						<dl class="selectionBox">
							...
							<dd>
								<ul>
									<li>
										<label for="disable_chat">
											<input type="checkbox" id="disable_chat" name="disable_chat" <?php if($disable_chat == 1) echo 'checked="checked"'; ?> value="1" />
											Disable chat
										</label>
									</li>
								</ul>
								<p class="explain">
									Checking this will completely disable chat on your site until it is unchecked again.
								</p>
							</dd>
						</dl>
					</fieldset>
					...
					<fieldset>
						...
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Specify a special background color for chat admins in the buddy list.  This should be in hex format without a leading #.  Leave blank for no special distinction.  Further customization can be done with the "chat_buddylist_admin_1" CSS class.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Specify a special text color for chat admins in the buddy list.  This should be in hex format without a leading #.  Leave blank for no special distinction.  Further customization can be done with the "chat_buddylist_admin_1" CSS class.
								</p>
							</dd>
						</dl>
					</fieldset>
