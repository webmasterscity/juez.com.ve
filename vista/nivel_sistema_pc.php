...
<div class="panel-heading">
				...
				<a title="Agregar nuevo registro" class="btn btn-success btn-sm" href="?codificar('vista=nivel_sistema_pc&evento=nuevo">Agregar Niveles de conocimientos PC</a>
				...
				<a class="btn btn-default btn-sm" href="?codificar('vista=nivel_sistema_pc"  style="float:right; <?php if($_GET['evento']!='nuevo' and $_POST['evento']!='consultar') echo 'display:none;';?>">
...
if($mostrar_formulario==true){
	echo '<form method="post" action="?codificar('vista=nivel_sistema_pc">';
