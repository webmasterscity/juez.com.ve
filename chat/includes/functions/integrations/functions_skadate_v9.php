<?php
	...
	*/
	...
	function get_friend_list($userid, $time) 
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity, (SELECT concat(profile_id,'_',photo_id,'_'," . TABLE_PREFIX . "profile_photo.index) from " . TABLE_PREFIX . "profile_photo where profile_id = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " and status = 'active' limit 1) avatar, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link, chat_status.is_admin, chat_status.status 
	...
	function get_user_details($userid) 
	{
		...
		$sql = ("
			SELECT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity,  " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link,  (SELECT concat(profile_id,'_',photo_id,'_'," . TABLE_PREFIX . "profile_photo.index) from " . TABLE_PREFIX . "profile_photo where profile_id = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " and status = 'active' limit 1) avatar, chat_status.is_admin, chat_status.status 
			FROM " . TABLE_PREFIX . DB_USERTABLE . " 
			LEFT JOIN chat_status 
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = chat_status.userid 
