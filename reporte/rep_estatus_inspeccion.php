<?php   require_once("libreria/fpdf/clsFpdf_vertical.php");
   require_once("modelo/class_estatus_inspeccion.php");
   ...
   $lobjPdf->Ln(10);
   $lobjPdf->Cell(0,6,utf8_decode("Reporte de Estatus de la inspección"),0,1,"C");
   $lobjPdf->Ln();
         //analizamos los nombres de las tablas con mas longitud para colocar de ese tamaño las celdas
         //Titulos de las Celdas
		 
		$nombre_cod_estatus_inspeccion="Codigo"; 
   ...
   $estatus_inspeccion->listar();
      while ($row=$estatus_inspeccion->row()){
				$suma_cod_estatus_inspeccion=$lobjPdf->GetStringWidth($row["cod_estatus_inspeccion"]);
   ...
   $lobjPdf->Ln();
      $estatus_inspeccion->listar();
   while ($row=$estatus_inspeccion->row()){
				$lobjPdf->Cell(($suma_mayor_cod_estatus_inspeccion+2),6,utf8_decode($row["cod_estatus_inspeccion"]),1,0,"R");
