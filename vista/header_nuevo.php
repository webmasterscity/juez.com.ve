...
<head><title>Sistema de Entrenamiento para Competencias Internacionales de Programación</title>
    ...
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="css/themes/style1/<?php echo ($_SESSION['tema'] ? $_SESSION['tema'] : 'leo-blue.css'); ?>" id="theme-change" class="style-change color-change">
