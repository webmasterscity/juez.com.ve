<li id="chatapplist_'+apps[b][0]+'" style="line-height: 16px; overflow: hidden hidden; padding: 1px 0px; zoom: 1;">
	<div>
		<a id="chat_app_link_'+apps[b][0]+'" class="chat_app_link" href="javascript:void(0);">
