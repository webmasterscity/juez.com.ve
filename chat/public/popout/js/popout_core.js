    ...
    a.chat = function () {
            ...
            b && a.each(b, function (i, e) {
                if (i == "buddylist") {
                    ...
                    a.each(e, function (l, f) {
                        ...
                        if (G[f.id] != null) {
                            a("#chat_popout_user_" + f.id + " .chat_closebox_bottom_status").removeClass("chat_available").removeClass("chat_busy").removeClass("chat_offline").removeClass("chat_away").addClass("chat_" + f.s);
                        }
                ...
                if (buddylistreceived == 1) {
                    for (buddystatus in c) if (c.hasOwnProperty(buddystatus)) c[buddystatus] == "" ? a("#chat_userslist_" + buddystatus).html("") : oa("chat_userslist_" + buddystatus, "<div>" + c[buddystatus] + "</div>");
        ...
        function sa(b, c, d) {
            if (uc_name[b] == null || uc_name[b] == "") setTimeout(function () {
                ...
                Oa(b);
                if (d == 1) if (a("#chat_popout_user_" + b + " .chat_popout_alert").length > 0) c = parseInt(a("#chat_popout_user_" + b + " .chat_popout_alert").html()) + parseInt(c);
                if (c == 0) {
                    a("#chat_popout_user_" + b + " .chat_popout_alert").remove();
                } else {
                    if (a("#chat_popout_user_" + b + " .chat_popout_alert").length > 0) {
                        a("#chat_popout_user_" + b + " .chat_popout_alert").html(c);
                    } else a("<div/>").addClass("chat_popout_alert").html(c).appendTo(a("#chat_popout_user_" + b + " .chat_popout_wrap"));
                }
                y[b] = c;
                S();
            }
		...
		function M() {
			a(".chat_popout_convo").css("height", a(window).height() - a("#chat_popout_open_chats").height() - 50);
		}
        function H() {
                    ...
                    if (b && b != null) {
                        ...
                        a.each(b, function (e, l) {
                            ...
                            if (e == "messages") {
								...
								D = E;
								showTimeAndTooltip();
                                d != 1 && u_sounds == 1 && !a(".chat_popout_convo_input").is(":focus") && Ua();
                            }
                        });
                        j != "" && i > 0 && za(j, c)
                    }
            ...
            if (uc_name[b] == null || uc_name[b] == "") setTimeout(function () {
                ...
                if (a("#chat_message_" + e).length) {
					...
					if (uc_status[b] == "offline" && d != 1) {
						displayMessage("chat_chatroom_message_flyout", lang[13], "error");
					}

					a("#chat_popout_user_" + b + "_convo .chat_popout_convo").append('<div class="chat_chatboxmessage chat_clearfix' + h + '" id="chat_message_' + e + '">' + ha(new Date(f * 1E3)) + '<div class="chat_chatboxmessagefrom"><div class="chat_disable_avatars_name">' + fromname + '</div><img alt="' + tooltip + '" class="chat_chatbox_avatar" src="' + avatar + '" /></div><div class="chat_chatboxmessage_wrapper"><div class="chat_chatboxmessagecontent">' + c + "</div></div></div>");
					last_sent[b] = f;
					last_name[b] = full_name;

                    a("#chat_popout_text_" + b).scrollTop(5E4);
					showTimeAndTooltip();
                }
				if (c_disable_avatars == 1 || u_no_avatars == 1) {
        ...
        function za(b, c) {
            if (uc_name[b] == null || uc_name[b] == "") setTimeout(function () {
                ...
                a("#chat_popout_text_" + b).append("<div>" + c + "</div>");
                a("#chat_popout_text_" + b).scrollTop(5E4);
                G[b] = 1
            }
        }
                ...
                a.ajax({
                    ...
                    success: function (o) {
                        if (o) {
                            ...
                            l = uc_link[b] = o.l;
                            if (G[b] != null) {
                                a("#chat_popout_user_" + b + " .chat_closebox_bottom_status").removeClass("chat_available").removeClass("chat_busy").removeClass("chat_offline").addClass("chat_" + d);
                            }
                            aa[b] = 0;
                            if (c != null) {
                                qa(b, c, d, e, l, f, h)
        ...
        function La(b) {
            a.ajax({
                ...
                success: function (c) {
                    if (c) {
                        a("#chat_popout_user_" + b + "_convo .chat_popout_convo").html("");
                        last_sent[b] = null;
                        var d = "",
                            i = uc_name[b];
                        a.each(c, function (e, l) {
                            e == "messages" && a.each(l, function (f, h) {
								...
								d += '<div class="chat_chatboxmessage chat_clearfix' + f + '" id="chat_message_' + h.id + '">' + ha(o) + '<div class="chat_chatboxmessagefrom"><div class="chat_disable_avatars_name">' + fromname + '</div><img alt="' + tooltip + '" class="chat_chatbox_avatar" src="' + avatar + '" /></div><div class="chat_chatboxmessage_wrapper"><div class="chat_chatboxmessagecontent">' + h.message + "</div></div></div>";
								last_sent[h.from] = h.sent;
								last_name[h.from] = full_name;
                            })
                        });
                        if (a("#chat_popout_text_" + b).length > 0) oa("chat_popout_text_" + b, "<div>" + d + "</div>" + document.getElementById("chat_popout_text_" + b).innerHTML);
                        else document.getElementById("chat_popout_text_" + b).innerHTML = "<div>" + d + "</div>";
                        a("#chat_popout_text_" + b).scrollTop(5E4);
						showTimeAndTooltip();
				...
				if (c_send_priv_msg == 1 && i != "") {
					...
					i != "" && a.post(c_ac_path + "includes/json/send/send_message.php", {
						...
						if (e) {
							...
							a("#chat_popout_user_" + d + "_convo .chat_popout_convo").scrollTop(a("#chat_popout_user_" + d + "_convo .chat_popout_convo")[0].scrollHeight)
						}
						K = 1;
						if (D > E) {
							D = E;
        ...
        function Ca(b, c, d) {
            a("#chat_popout_user_" + d + "_popup .chat_popout_convo").scrollTop(a("#chat_popout_user_" + d + "_convo .chat_popout_convo")[0].scrollHeight)
        }
        function qa(b, c, d, e, l, f) {
            if (G[b] != null || a("#chat_popout_user_"+b+"_convo").length > 0) {
                if (!a("#chat_user_" + b).hasClass("chat_tabclick") && f != 1) {
					j = b;
					a(".chat_popout_convo_wrapper").removeClass("chat_popout_convo_focused");
					a(".chat_popout_tab").removeClass("chat_popout_focused");
					a("#chat_popout_user_" + b + "_convo").addClass("chat_popout_convo_focused");
					a("#chat_popout_user_" + b).addClass("chat_popout_focused");
					if (ca[b] != 1) {
						La(b);
						ca[b] = 1
					}
                ...
                a("<div/>").attr("id", "chat_popout_user_" + b).addClass("chat_popout_tab").html('<div class="chat_bar_left"><div class="chat_popout_wrap"><div class="chat_popout_tab_name">' + shortname + '</div><div class="chat_closebox_bottom_status chat_' + d + '" style="margin-top:4px;"></div></div></div><div class="chat_popout_right"><div class="chat_closebox_bottom"></div></div>').appendTo(a("#chat_popout_container"));
				a("<div/>").attr("id", "chat_popout_user_" + b + "_convo").addClass("chat_popout_convo_wrapper").html('<div id="chat_popout_text_' + b + '" class="chat_popout_convo"></div><div class="chat_popout_input_container"><div class="chat_smiley_button"><div class="chat_more_wrapper chat_smiley_popout"><div class="chat_more_popout"><div class="chat_smiley_box"></div><i class="chat_more_tip"></i></div></div></div><div id="chat_upload_button_' + b + '"><div id="chat_chatroom_uploader"> </div></div><div class="chat_popout_input_wrapper"><textarea class="chat_popout_convo_input"></textarea></div></div>').appendTo(a("#chat_popout_chat"));
                a("#chat_popout_user_" + b + " .chat_closebox_bottom").mouseenter(function () {
                    a(this).addClass("chat_closebox_bottomhover")
                });
                a("#chat_popout_user_" + b + " .chat_closebox_bottom").mouseleave(function () {
                    a(this).removeClass("chat_closebox_bottomhover")
                });
                a("#chat_popout_user_" + b + " .chat_closebox_bottom").click(function () {
                    a.post(c_ac_path + "includes/json/send/send_settings.php", {
                        userid: u_id,
                        close_chat: b,
                        tab_alert: 1
                    }, function () {});
					a("#chat_popout_user_" + b + "_convo").remove();
                    a("#chat_popout_user_" + b).remove();
                    if (j == b) j = "";
                    y[b] = null;
                    G[b] = null;
                    ca[b] = 0;
                });
                a("#chat_popout_user_" + b + "_convo .chat_popout_convo_input").keydown(function (h) {
                    return O(h, this, b)
                });
                a("#chat_popout_user_" + b + "_convo .chat_popout_convo_input").keyup(function (h) {
                    return Ca(h, this, b)
                });
				a("#chat_popout_user_" + b).click(function () {
					var tba = 0;
                    if (a("#chat_popout_user_" + b + " .chat_popout_alert").length > 0) {
                        tba = 1;
                        a("#chat_popout_user_" + b + " .chat_popout_alert").remove();
                    ...
                    if (a(this).hasClass("chat_popout_focused")) {
                        a(this).removeClass("chat_popout_focused");
						a("#chat_popout_user_" + b + "_convo").removeClass("chat_popout_convo_focused");
                        j = "";
                        a.post(c_ac_path + "includes/json/send/send_settings.php", {
                            userid: u_id,
                            unfocus_chat: b,
						...
						a("#chat_popout_user_" + b + "_convo").addClass("chat_popout_convo_focused");
						j = b;
						a("#chat_popout_user_" + b + "_convo .chat_popout_convo_input").focus()
					}
                    a("#chat_popout_user_" + b + "_convo .chat_popout_convo").scrollTop(a("#chat_popout_user_" + b + "_convo .chat_popout_convo")[0].scrollHeight);
				});
				var smiley_exist = [];
				for (var i = 0; i < Smiley.length; i++) {
					if (a.inArray(Smiley[i][0], smiley_exist) > -1) {
					} else {
						a("#chat_popout_user_" + b + "_convo .chat_smiley_box").append('<div class="chat_smiley_wrapper" data-id="'+i+'"><img class="chat_smiley" src="'+c_ac_path+'themes/'+u_theme+'/images/smilies/'+Smiley[i][0]+'.png" alt="" /></div>');
						smiley_exist.push(Smiley[i][0]);
					}
				}
				a("#chat_popout_user_" + b + "_convo .chat_smiley_button").mouseenter(function () {
					a(this).addClass("chat_smiley_button_hover")
				});
				a("#chat_popout_user_" + b + "_convo .chat_smiley_button").mouseleave(function () {
					a(this).removeClass("chat_smiley_button_hover");
				});
				a("#chat_popout_user_" + b + "_convo .chat_smiley_wrapper").click(function () {
					var smiley_code = a(this).attr("data-id");
					var existing_text = a("#chat_popout_user_" + b + "_convo .chat_popout_convo_input").val();
					a("#chat_popout_user_" + b + "_convo .chat_popout_convo_input").focus().val('').val(existing_text + Smiley[smiley_code][1]);
				});
				a("#chat_popout_user_" + b + "_convo .chat_smiley_button").click(function () {
					if (a(".chat_smiley_popout").is(":visible")) {
						a(".chat_smiley_popout").children(".chat_more_popout").hide();
					} else {
						a(".chat_smiley_popout").children(".chat_more_popout").show();
					}
				});
				if (c_disable_smilies == 1) {a(".chat_smiley_button").hide();}
				uploadProcessing(b);
				if (c_file_transfer != 1) {
					a("#chat_upload_button_" + b).hide();
				}
		...
		function uploadProcessing(b) {
			...
			a("#chat_upload_button_" + b).uploadify({
				...
				'onUploadSuccess': function (file) {
					...
					a.post(c_ac_path + "includes/json/send/send_message.php", {
						...
						a(".chat_popout_convo").scrollTop(5E4);
					});
				}
			});
			a("#chat_upload_button_" + b).mouseenter(function () {
				a(this).addClass("chat_upload_button_hover")
			});
			a("#chat_upload_button_" + b).mouseleave(function () {
		...
		function receiveMessage(id, from, message, sent, self, old) {
			...
			if (j == from && uc_name[from] != "" && uc_name[from] != null) {
				var container = a("#chat_popout_text_" + from)[0].scrollHeight - a("#chat_popout_text_" + from).scrollTop() - 10;
				var container2 = a("#chat_popout_text_" + from).outerHeight();
				var o = uc_name[from];
				...
				if (a("#chat_message_" + id).length) {
					...
					a("#chat_popout_user_" + from + "_convo .chat_popout_convo").append('<div class="chat_chatboxmessage chat_clearfix' + f + '" id="chat_message_' + id + '">' + ha(new Date(sent * 1E3)) + '<div class="chat_chatboxmessagefrom"><div class="chat_disable_avatars_name">' + fromname + '</div><img alt="' + tooltip + '" class="chat_chatbox_avatar" src="' + avatar + '" /></div><div class="chat_chatboxmessage_wrapper"><div class="chat_chatboxmessagecontent">' + message + "</div></div></div>");
					last_sent[from] = sent;
					last_name[from] = full_name;
				}
				if (container <= container2 || !a("#chat_popout_user_"+from).hasClass("chat_popout_focused")) {
					a("#chat_popout_text_" + from).scrollTop(5E4);
					a(".chat_image_message img").one("load", function() {
						setTimeout(function () {
							a("#chat_popout_text_" + from).scrollTop(5E4);
						}, 500);
				...
				f = 0;
				if (!(a("#chat_popout_user_" + from).length > 0)) {
					a.post(c_ac_path + "includes/json/send/send_settings.php", {
						unfocus_chat: from
					}, function () {});
					f = 1
		...
		function pushReceive(data) {
			...
			if ("messages" in data) {
				...
				u_sounds == 1 && !a(".chat_popout_convo_input").is(":focus") && Ua();
				showTimeAndTooltip();
				K = 1;
				D = E;
			}
