	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			jQuery.getFeed({
				url: './includes/functions/functions_proxy_rss.php?url=http://www.chat.com/blog/wp-rss2.php',
			...
			<div class="title_bg" id="content-overview"> 
				...
				<div class="module_content">
					...
					<table cellspacing="0" cellpadding="0">
						...
						<tr style="height: 25px;">
							<td class="row1">chat Installed:</td>
      ...
      <div class="title_bg" id="content-recent"> 
		...
		?>
			...
			<div class="title_bg" id="content-blog" style="width:500px"> 
				<div class="title">chat Facebook Page</div> 
				<div class="module_content" style="padding: 0px;">
					<iframe src="//www.facebook.com/connect/connect.php?name=chat&connections=6&stream=1&show_border=false&show_posts=true&width=500&height=400" width="500" height="400" scrolling="no" frameborder="0"></iframe>
				</div>
			</div>
			<div style="clear: both;"></div>