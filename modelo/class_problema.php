...
// CREAMOS LOS METODOS SET		
	...
	public function listar_lenguajes(){		
		return parent::ejecutar("SELECT * FROM problema INNER JOIN det_problema_lenguaje_prog USING (cod_problema) INNER JOIN lenguaje_prog USING (cod_lenguaje_prog) WHERE lenguaje_prog.estatus='1' AND problema.cod_problema=".$this->cod_problema);
	}
