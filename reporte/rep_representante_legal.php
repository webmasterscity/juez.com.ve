<?php   require_once("libreria/fpdf/clsFpdf_vertical.php");
   require_once("modelo/class_representante_legal.php");
   ...
   $lobjPdf->Ln(10);
   $lobjPdf->Cell(0,6,"Reporte de Representante legal",0,1,"C");
   $lobjPdf->Ln();
   ...
   $representante_legal->listar();
      while ($row=$representante_legal->row()){
