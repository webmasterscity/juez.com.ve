									...
									$(this).iTip({
										...
										'icons' : [
											...
											},
											{
												...
												'click' : function()
												{
													window.open('http://www.chat.com/members/store.php?do=purchases','new');
												}
											},
											{
												'id' : 'save',
						...
						<dl class="selectionBox">
							...
							<dd>
								<select multiple="multiple" id="add_chatroom_group" name="add_chatroom_group[]" style="width: 440px; height: 125px;">
									<option value="acg">chat Guests (acg)</option>
								<?php	
				...
				<div class="module_content">
					...
					<fieldset>
						...
						<dl class="selectionBox">
							...
							<p class="explain">
								This is the chat room you would like chat to automatically join upon loading (until the user leaves it). Password protected and admin rooms cannot be auto joined.
							</p>
						</dd>
					</dl>
					<dl class="selectionBox">
						...
						<dl class="selectionBox">
							...
							<dd>
								...
								<select multiple="multiple" id="edit_chatroom_group" name="edit_chatroom_group[]" style="width: 440px; height: 125px;">
									<option value="acg" <?php if (in_array('acg', $disallowed_groups)) echo 'selected="selected"'; ?>>chat Guests (acg)</option>
								<?php	
										$groups_list = get_all_groups();
...
?>
					...
					<div class="subExplain"><i>Notifications must first be installed correctly to function properly. Please visit http://www.chat.com/support/ for documentation on installation.</i></div>
