<?php
	...
	*/
	...
	function get_friend_list($userid, $time)
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity, concat(" . TABLE_PREFIX . "user_avatar.fileHash, '^', " . TABLE_PREFIX . "user_avatar.avatarExtension, '^', " . TABLE_PREFIX . "user_avatar.avatarID) avatar, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link, chat_status.is_admin, chat_status.status 
	...
	function get_user_details($userid) 
	{
		...
		$sql = ("
			SELECT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, chat_status.session_time lastactivity,  " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link,  concat(" . TABLE_PREFIX . "user_avatar.fileHash, '^', " . TABLE_PREFIX . "user_avatar.avatarExtension, '^', " . TABLE_PREFIX . "user_avatar.avatarID) avatar, chat_status.is_admin, chat_status.status 
			FROM " . TABLE_PREFIX . DB_USERTABLE . " 
			LEFT JOIN chat_status 
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = chat_status.userid 
			LEFT JOIN " . TABLE_PREFIX . "user_avatar
